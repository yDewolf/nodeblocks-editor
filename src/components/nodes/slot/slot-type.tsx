...
export class BaseSlotType {
    ...
    constructor(type: SuperSlotTypes, type_whitelist: SuperSlotTypes[], type_name: string = "default", name_whitelist: string[] = []) {
    ...
    public can_connect_to(other_type: BaseSlotType): boolean {
        if (this.type_whitelist.includes(other_type.super_type) || this.name_whitelist.includes(other_type.type_name)) {
            return true;
        }
...
export class CustomSlotType extends BaseSlotType {
    constructor(type: string, type_whitelist: string[], type_name: string) {
        ...
        super(parsed_type, parsed_type_wl, type_name, parsed_name_wl);
    }
...
export const INPUT_SLOT = new BaseSlotType(SuperSlotTypes.INPUT, [SuperSlotTypes.OUTPUT], "default_input");
export const OUTPUT_SLOT = new BaseSlotType(SuperSlotTypes.OUTPUT, [SuperSlotTypes.INPUT], "default_output");
