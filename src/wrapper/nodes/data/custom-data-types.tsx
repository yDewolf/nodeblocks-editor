import { BaseDataType, DataTypeUtils, UNKNOWN_TYPE } from "./node-data-type";

export class CustomDataType extends BaseDataType {
    constructor(type_id: string, data_type?: string, conn_whitelist: string[] = []) {
        ...
        super(type_id, parsed_data_type.base, type_whitelist, name_whitelist);
    }
}